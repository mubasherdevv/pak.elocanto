...
import { getAreas, getAreaBySlug, createArea, updateArea, deleteArea, bulkCreateAreas, bulkDeleteAreas, bulkUpdateAreas } from '../controllers/areaController.js';
...
router.route('/bulk')
  ...
  .put(protect, admin, bulkUpdateAreas)
