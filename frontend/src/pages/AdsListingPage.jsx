      ...
      {showPopupAd && (
        <div style={{
          ...
          <div style={{
            ...
            padding: '40px 30px', borderRadius: 24, width: '90%', maxWidth: 400,
            ...
            <div style={{
              width: 70, height: 70, background: '#25D366', borderRadius: '50%',
            ...
            <h2 style={{ color: 'white', fontSize: 24, fontWeight: 900, marginBottom: 10, textTransform: 'uppercase', letterSpacing: 1 }}>
              Top Paid Ads!
            </h2>
            <p style={{ color: '#a1a1aa', fontSize: 14, marginBottom: 24, lineHeight: 1.5 }}>
              For Paid Advertisement in Website Content, Contact us directly on WhatsApp!
            </p>
            
            <a href="https://wa.me/923218637548" target="_blank" rel="noreferrer" 
               style={{
