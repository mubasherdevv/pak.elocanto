...
export default function Navbar({ onMenuClick }) {
    ...
    return (
        <header style={{ background: 'white', position: 'relative', zIndex: 100, borderBottom: '1px solid #f1f5f9', boxShadow: '0 4px 20px -5px rgba(0,0,0,0.05)', display: 'flex', flexDirection: 'column', width: '100%' }}>
            {/* Top Marquee Banner */}
                ...
                <div className="marquee-content">
                    {Array.from({ length: 8 }).map((_, i) => (
                        <div key={i} className="marquee-text">
                            ...
                            <a href="https://wa.me/447490809237?text=Hello!%20I%20saw%20your%20advertisement%20on%20your%20Elocanto%20Website.%20I'm%20interested%20in%20promoting%20my%20business.%20Can%20you%20please%20tell%20me%20about%20the%20available%20ad%20plans,%20pricing,%20and%20how%20many%20daily%20visitors%20you%20get?" target="_blank" rel="noreferrer" className="highlight" style={{ textDecoration: 'none' }}>
